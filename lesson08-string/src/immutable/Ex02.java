...
public class Ex02 {
	public static void main(String[] args) {
		...
		System.out.println("(l1==l3): " + (l1==l3)); // F
		System.out.println("(l1==l4): " + (l1==l4)); // F
		System.out.println("(l2==l4): " + (l2==l4)); // T
		
		System.out.println("(o1==o2): " + (o1==o2)); // F
		System.out.println("(o1==o3): " + (o1==o3)); // F
		System.out.println("(o1==o4): " + (o1==o4)); // F
		System.out.println("(o2==o4): " + (o2==o4)); // F
		...
		System.out.println("(o2 eq o4): " + (o2.equals(o4))); // T
		...
		System.out.println("A cpt D: " + ("A".compareTo("D")));
