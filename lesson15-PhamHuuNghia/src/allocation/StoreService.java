...
public class StoreService {
    ...
    private static Map<Long, Integer> doAllocation(Integer whAllocationAmount, List<Store> data) {
    	...
    	Map<Store, BigDecimal> expectedSales=null;
    	//Step one: 
    	try {
    		expectedSales = Utils.getRealexpectedSale(Utils.selectedStore(data));
		} catch (Exception e) {
    	...
    	//Step 2:
    	Map<Store, BigDecimal> allocationKey = Utils.getAllocationKey(expectedSales);
