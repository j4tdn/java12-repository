...
public class Ex07 {
	...
	public static void main(String[] args) {
		...
		System.out.println("itemA exist "+ items.contains(itemA));//F
		System.out.println("itemB exist "+ items.contains(itemB)); //T 
		System.out.println("itemC exist "+ items.contains(itemC)); //T
	...
	private static List<Item> getItems(){
		...
		Item item4 = new Item(4,40,"A40",400);
